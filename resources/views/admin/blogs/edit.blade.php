            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="custom-control custom-radio custom-control-inline">
                        <input type="radio" name="status" {{$blog->status == 1 ? 'checked' : ''}} class="custom-control-input" value="1"><span class="custom-control-label">Enable</span>
                    </label>
                    <label class="custom-control custom-radio custom-control-inline">
                        <input type="radio" name="status" value="0" {{$blog->status == 0 ? 'checked' : ''}}><span class="custom-control-label">><span class="custom-control-label">Disable</span>
                    </label>
                </div>
            </div>
    <div class="col-md-12">
